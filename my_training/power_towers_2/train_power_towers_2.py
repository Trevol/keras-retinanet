...
def train(trainAnnotationsFile, classMappingFile, valAnnotationFile=None, batchSize=2,
    ...
    args = ['--workers=0',
            ...
            '--epochs=50',
            '--steps=1000',
            '--snapshot-path=/mnt/HDD/training_checkpoints/keras_retinanet/power_towers_2']
    if snapshot:
...
def main():
    ...
    ret = train(trainAnnotations, classMapping, valAnnotations, batchSize=2,
                snapshot='/mnt/HDD/training_checkpoints/keras_retinanet/power_towers_2/resnet50_csv_01.h5',  # './snapshots/resnet50_csv_08.h5'
